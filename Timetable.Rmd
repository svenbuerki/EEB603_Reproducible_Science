...
The tentative timetable for this course is available in Table \@ref(tab:timetab). The instructor wants to warn students that he might adjust the timetable to accommodate progress and needs. However, in case of changes, the instructor will make sure to contact enrolled students to keep them posted.

```{r timetab, echo=FALSE}
###~~~
# Build a data frame with all dates from beginning to end of Fall semester
###~~~
dates <- data.frame(seq.Date(from=as.Date("2023/08/21"), to=as.Date("2023/12/15"), by="day"))
...
holiday <- seq.Date(from=as.Date("2023/11/20"), to=as.Date("2023/11/26"), by="day")
...
###~~~
knitr::kable(timetable,  caption = "Tentative timetable for the EEB603 Reproducible Science course during the 2023 Fall semester.") %>%
