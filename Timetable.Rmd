...
###~~~
dates <- data.frame(seq.Date(from=as.Date("2022/08/22"), to=as.Date("2022/12/09"), by="day"))
...
holiday <- seq.Date(from=as.Date("2022/11/21"), to=as.Date("2022/11/27"), by="day")
...
###~~~
knitr::kable(timetable,  caption = "Tentative timetable for the Reproducible Science course during the 2022 Fall semester.") %>%
