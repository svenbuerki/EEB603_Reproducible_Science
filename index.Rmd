...
**Arc 2 -- The [Individual Project](#Report) (PART 3), 300 points.** The same sequence applied to your own research: you *plan* a piece of reproducible work, you *build* it, and you *communicate* it.

4. A mandatory [project proposal](#Proposal), due about a third of the way through the semester (50 points).
5. The [final report](#Report) (150 points).
...
Across all three stages of your individual project --- the [proposal](#Proposal), the [final report](#Report) and the [oral presentation](#Oral) --- **you may use generative AI tools**, provided that your use is consistent with scientific integrity and research ethics. This is deliberate: AI tools are becoming part of the research workflow you will enter after this course, and learning to use them well -- critically, transparently, and reproducibly -- is itself a reproducible-science skill.
