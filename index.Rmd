...
ai <- data.frame(
  "Assessment" = c("Participation and engagement (50 pts)",
                   "Bioinformatics tutorial (150 pts)",
                   "Teaching the tutorial (100 pts)",
                   "Project proposal (50 pts)",
                   "Final report (150 pts)",
                   "Oral presentation (100 pts)"),
  "AI use" = c("Not applicable -- in class",
               "Limited",
               "Not used during teaching",
               "Permitted",
               "Permitted",
               "Permitted in preparation"),
  "Core condition" = c("Contribute in your own words",
                       "You write and knit the code yourself",
                       "You lead and answer questions live",
                       "Disclose use; the plan must be yours",
