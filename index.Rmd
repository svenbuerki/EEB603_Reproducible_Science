...
<div style="text-align: right"> [Download pdf version](Data/EEB603_Syllabus_BUERKI_2023.pdf) </div>
...
In-person in [Raptor Research Center Building, Rm 119](https://maps.boisestate.edu/?id=715#!m/115308?share).
...
1. **The reproducibility crisis & prospects to tackle it!**
   - Introduction: What is Reproducible Science?
...
## <a name="Publis"></a>Publications and Textbooks
...
These documents together with the material presented in [publications & textbooks](#Publis) will provide the basis to design your [bioinformatics tutorials](#BioTut). 
...
There will not be any classical exams in this course, but we will rather focus on developing theoretical and bioinformatics skills and applying those to your research. In this context, each student will be asked to produce a bioinformatics tutorial and teach it to their peers (see [PART 2](#PART2)). Each student will also be tasked to produce a report (tailored to their thesis project or a publication) and present their results and conclusions in class. 

## Mandatory Assignments

Students will be graded on the following four mandatory assignments:

1. Produce a group bioinformatics tutorial based on a chapter from [PART 2](#PART2) (150 points).
...
These assignments total **550 points**. Table @ref(tab:mygrade) shows the grading scale used in this course.
...
## <a name="BioTut"></a>Bioinformatics Tutorial (150 points)

During the first two weeks, students will [sign up](#GoogleBioTut) for a chapter from [PART 2](#PART2) to study and create a bioinformatics tutorial. Depending on enrollment, tutorials will be developed individually or in groups, with support from the instructor (see details below).

Tutorials must be written using *knitr*/*rmarkdown* in RStudio and focus on a set of exercises designed to build key bioinformatics skills related to the chosen chapter (see [PART 2](#PART2)). Students are encouraged to use materials from @Gandrud2015 and @Wickham2017, or other properly cited sources. For additional resources, see the [Publications and Textbooks](#Publis) and [RStudio Cheat Sheets](#Cheat) sections.
...
### <a name="GoogleBioTut"></a>Google Sheet for Bioinformatics Tutorials

The instructor is asking students to sign up for designing and teaching a bioinformatics tutorial by accessing the following Google sheet (the number of students per chapter is provided, please respect this guideline):

- https://docs.google.com/spreadsheets/d/1gUwbqJ4gbhhSY1DfsZ7HsoDLzOKB-57xAAC1_IJ3qmk/edit?usp=sharing

## <a name="TeachTut"></a>Teaching Tutorials (100 points)
