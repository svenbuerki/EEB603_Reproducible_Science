...
<div style="text-align: right"> [Raw data on GitHub](https://github.com/svenbuerki/ReproducibleScience) </div>
...
- Use sanitizing wipes to clean surfaces (desk and keyboard) at beginning and end of class.
- Keep using the same seat throughout the semester. This information should be entered into MyBoiseState.
- Do not attend class if you are sick.

For more information consult the [BSU campus guidelines](https://www.boisestate.edu/coronavirus-response/).
...
Ultimately, this course aims at **providing students with key knowledge to gather, store, share, prepare and analyze their data as well as communicate their results to the scientific community** (see Figure \@ref(fig:part2)).
