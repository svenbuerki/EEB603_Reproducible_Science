...
- Each group will present a definition of one of the [common key threats](#gloss) to the scientific process and explain where it occurs. Additionally, each group must propose a [solution](#soltothreats) to mitigate this threat. Use the resources provided in this document to carry out your group assignment.
    + Group 1: **HARKing**
...
- Each group is tasked to:
    1. Study the [TOP Guidelines](#TOPguidelines).  
    2. Select a target journal and determine how it applies these guidelines. Here is an example of how *Science* applies the TOP Guidelines in its journal: https://www.science.org/content/page/science-journals-editorial-policies#TOP-guidelines  
    3. Report their findings and conclusions to the class.
