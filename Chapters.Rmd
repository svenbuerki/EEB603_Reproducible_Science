...
- Install R Markdown (incl. dependencies) on your computer. 
...
- Create your own functions (referred to as user-defined functions or UDFs) to support your research needs.
...
To comment inside text (= in the Markdown section) use the following syntax borrowed from the `HTML` language.
...
Usually, we are using this syntax to e.g. highlight where we need improvement in the text, but these will not be rendered/visible when the document is knitted.
