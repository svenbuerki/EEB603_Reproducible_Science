...
The `PDF` of the presentation can be downloaded [here](Chapters_files/Chapter_1_Part_B_Reproducibility_crisis.pdf). The PDFs of @Baker_2016 and @NAP25303 are available in our shared Google Drive at the following paths:
...
The most relevant recommendations proposed by @NAP25303 for our course are listed in the following table.
