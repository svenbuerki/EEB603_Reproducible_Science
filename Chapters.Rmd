...
8. [Build the Class Charter](#classcharter) <span style="color:dimgray;">(10 minutes)</span>

The first five sections will be covered during Session 1, while the remaining three will be addressed in Session 2.  
...
**Resolve nothing and delete nothing.** The threads are a record of which standards survived scrutiny and which did not, and we will read them again when we build the [class charter](#classcharter).
...
#### 🤝 Build the Class Charter <span style="color:dimgray;">(10 minutes)</span> {#classcharter}

Both charters now go up side by side, and we finish Part B by finding what they have in common.

1. **What did you both arrive at?** <span style="color:dimgray;">(~4 minutes)</span>
   Read across the two documents and mark every standard that appears, in some form, in **both**. Two teams working independently from the same evidence and landing on the same clause is the strongest signal we have that it matters --- that is consensus, not coincidence.

2. **Where did you differ?** <span style="color:dimgray;">(~3 minutes)</span>
   Take a clause only one group wrote. Is it a **blind spot** in the other charter, or a genuine difference between the kinds of research you do --- field data and code do not face identical risks? Both answers are worth having; say which one it is.

3. **Agree the class charter** <span style="color:dimgray;">(~3 minutes)</span>
   We settle on the clauses we hold in common, and I record them as our **class charter**, saved beside your group documents in [`Reproducible_Science > Chapters > Chapter_1 > Part_B`](https://drive.google.com/drive/folders/1l3ZwbVjiswHWdW38wt5Hd7VxS-_uHKOG?usp=drive_link).

<blockquote>
📌 <b>This is the document we come back to.</b> What you have written today is developed properly in
...
Peer Review</a>. Each time we return to it you should be able to take a clause and say how you would <i>now</i>
actually implement it --- and, by December, whether we were ambitious enough. Your group charter stays yours; the
class charter is what we hold in common.
</blockquote>
