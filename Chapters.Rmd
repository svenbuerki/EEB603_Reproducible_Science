...
1. Insert an R code chunk directly below your YAML metadata section (see Figure \@ref(fig:RMarkdwnstrct)).
...
<div class="danger">
  ...
  <ul>
    <li>Add the code to generate <code>packages.bib</code> in your R code chunk entitled "packages".</li>
    <li>Knit your document and inspect your project folder to observe the creation of a new file entitled <code>packages.bib</code>.</li>
  </ul>
</div>
...
```
3. Insert an R code chunk directly below `# Appendix 1` to read and print the citations saved in `packages.bib`. Use the following code:
...
This R Markdown document will be used as a template for the rest of Chapter 2 and also serves as a foundation for your Bioinformatics Tutorial.
...
- [**Insert tables and figures in an R Markdown document**](#insertTabFig)
- [**Cross-reference tables and figures in the text**](#crossrefTabFig)
- [**Cite references in the text and add a References section**](#bib)
- [**Format citations according to journal style**](#cslForm)

### Insert tables and figures in R Markdown document {#insertTabFig}
...
### Cite references in text and add a References section {#bib}
