...
- Learning about SHA-1 hash accession number and usage to retrieve specific `csv` files associated to GitHub `commit` events.
- Downloading whole GitHub repository.
- Listing all files in a compressed zip file.
- Extracting and saving selected files from zip file (without decompressing it).
...
This repository is associated to @Barron2020 and is used to demonstrate procedure to download whole GitHub repositories. We will be downloading the whole repository and then extracting all `csv` files in the `01_Raw_Data/` folder. This approach is aimed at demonstrating how you could access raw data deposited on GitHub. The repository is located at this URL: 
...
#### Download GitHub repository on your computer
...
#### Extract raw data from compressed GitHub repository 
...
We can verify that all the files are in the newly created directory on your computer by listing them as follows:
```{r}
