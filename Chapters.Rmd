...
- [Learn the syntax to implement user-defined functions in R](#syntaxUDFs)
- Learn R-specific functions associated with producing and loading functions
- Gain background on R lists and their applicability to functions returning multiple values
- Develop, implement, and apply user-defined functions returning single and multiple values
- Learn protocols to implement defensive programming in your code
- Understand the use of logical operators in R

To gain this knowledge, students will be conducting three exercises. To demonstrate the broad applications of the teaching material, we will be using mathematical examples. Before delving into these topics, the instructor will provide some general context and touch upon what a function is, when it is best applied, best practices for writing pseudocode/code (more during [Chapter 5](#Chap5)), and approaches to calling R functions.
...
### Syntax to Implement User-Defined Functions in R {#syntaxUDFs}
