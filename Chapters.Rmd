...
You can learn more about YAML and its application to R Markdown [here](https://zsmith27.github.io/rmarkdown_crash-course/lesson-4-yaml-headers.html).
...
3. Copy `Bibliography_Reproducible_Science_2.bib` and `AmJBot.csl` in your project folder. These files are available on the Shared Google Drive folder:
  + `Reproducible_Science/Chapters/Chapter_1/Tutorial_files`
4. Edit the YAML metadata section as shown in the [section](#YAMLset) above.  
