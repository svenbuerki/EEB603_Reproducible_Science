...
It is best practice to add an R code chunk directly below the YAML metadata section to automatically install and load the required R packages. This ensures that all dependencies needed to produce your document are installed and available (see Figure \@ref(fig:RMarkdwnstrct)).

This approach also allows you to automatically generate a citation file for all R packages used in your report (see [below](#citfileRpkg)). Applying this method contributes to improving the reproducibility of your research!
