...
1. The diagram outputted by step 3 is displayed in the `Plots` window (in the bottom right corner) and can be exported by clicking on the ![](Figures/Export_button.png) button and select `Save as Image...` as shown in Figure \@ref(fig:ExportDiag1).

```{r ExportDiag1, echo=FALSE, fig.align="center", fig.cap="Snapshot showing how to export the diagram in RStudio.", out.width = '100%'}
...
```{r ExportDiag2, echo=FALSE, fig.align="center", fig.cap="Snapshot showing how to save the diagram in RStudio.", out.width = '100%'}
...
- **PART B:** Writing papers in R Markdown.
