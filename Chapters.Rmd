...
Before delving into the cause leading to irreproducible science, we need to look into the differences between replication and reproduction. The material presented here has been adpated from [RESCIENCE C](http://rescience.github.io/).
