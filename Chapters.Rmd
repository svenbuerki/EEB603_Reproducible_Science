...
#### Step-by-Step Protocol <span style="color:gray;">(10 minutes)</span>
...
##### Challenge <span style="color:gray;">(10 minutes)</span>
...
#### Double "Table" in Caption <span style="color:gray;">(10 minutes)</span>
...
#### Step-by-Step Procedure <span style="color:gray;">(10 minutes)</span>
...
###### Challenge <span style="color:gray;">(5 minutes)</span>
...
3. Insert an R code chunk (using the `Insert` ![](Figures/insert.png) button) directly below your `packages` code chunk and name it `setup`. This code chunk will be used to define the global settings via the `opts_chunk$set()` function.
...
#### Challenge <span style="color:gray;">(15 minutes)</span> {.tabset}
...
#### Implement and Load the UDF in R <span style="color:gray;">(10 minutes)</span>
...
#### Apply Your Function <span style="color:gray;">(5 minutes)</span>
...
#### Student Activity and Solution <span style="color:gray;">(25 minutes)</span> {.tabset}
...
#### Case Study <span style="color:gray;">(25 minutes)</span>
...
```{r SciProcess, echo=FALSE, fig.align="center", fig.cap="Overview of the scientific process.", out.width = '80%'}
...
## 🤝 Group Sharing and Discussion <span style="color:gray;">(20 minutes)</span>
...
#### FAIR Principles Group Activity <span style="color:gray;">(15 minutes)</span>
...
#### CARE Principles Group Activity <span style="color:gray;">(15 minutes)</span>
...
#### FAIR & CARE Principles Comparison Activity <span style="color:gray;">(10 minutes)</span>
...
1. The diagram generated in Step 3 is displayed in the `Viewer` window (bottom right panel). It can be exported by clicking the ![](Figures/Export_button.png) button and selecting `Save as Image...`, as shown in Figure \@ref(fig:ExportDiag1).
