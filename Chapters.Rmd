...
In this chapter, we are studying the mechanisms implemented to promote Open Science while highlighting reasons or cases where other principles might have to be adopted to respect different views, opinions and/or data sovereignty.
...
- Introduce the CARE Principles and data sovereignty concept and how these apply to Indigenous Peoples.
