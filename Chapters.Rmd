...
#### 1. What do you remember? <span style="color:dimgray;">(10 minutes)</span>

You have read @Baker_2016 for today. **Without opening it**, agree as a group and write down:

- of the 1,576 researchers surveyed, what share reported a *significant* crisis?
- what proportion of published work in **your own field** do you believe is reproducible?
- which **three factors** did respondents blame most often?

**Commit to numbers.** Recalling something and getting it wrong fixes the correct answer in memory far better than reading it a second time does.

Now check. Where were you furthest out, and which factor did you under-estimate?

Finish this step by agreeing the **three factors your team judges most dangerous to your own research**. Those three are what your charter has to defend against.

#### 2. The factors, together <span style="color:dimgray;">(5 minutes)</span>
...
Keep your three factors in front of you: if something named here is not on your list, add it --- your charter is about to have to deal with it.

#### 3. Draft the charter <span style="color:dimgray;">(20 minutes)</span>

Each lead drafts the clauses for their own section. Between you, the charter must address all three factors from step 1, and you may consult the [recommendations table](#NASEMrec) for wording and for what others have proposed.
...
#### 4. Stress-test another team's charter <span style="color:dimgray;">(15 minutes)</span>

Swap charters with the other group --- you review theirs, they review yours. Your job now is to be the sceptic:
...
Then hand it back with your challenges. **Each lead answers the challenges to their own section** --- defend the clause, or concede and rewrite it. Both are good answers; neither is a loss.

#### 5. Revise and commit <span style="color:dimgray;">(10 minutes)</span>
...
The presentation associated with this class is below. We work through it in [step 2 of the activity](#FactorsActivity), after you have committed to your own answers --- and it is here afterwards for revision.
...
The most relevant recommendations proposed by the @NAP25303 for our course are listed in the table below. It is searchable, so in [step 4 of the activity](#FactorsActivity) you can look up the factor you were assigned rather than reading the whole table.
