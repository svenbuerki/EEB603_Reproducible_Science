...
<div style="text-align: center;">
  <button id="toggleButton{unique_id}" onclick="toggleFullScreen{unique_id}()">Enter Full Screen</button>
...
<script>
function toggleFullScreen{unique_id}() {{
  var elem = document.getElementById("pdfFrame{unique_id}");
  var button = document.getElementById("toggleButton{unique_id}");
  
  // Refresh iframe source with timestamp to avoid caching issues
  var pdfUrl = "{pdf_path}?" + new Date().getTime();
  elem.src = pdfUrl;
...
document.addEventListener("fullscreenchange", function() {{
  ...
  if (document.fullscreenElement) {{
    ...
    elem.src = "{pdf_path}?" + new Date().getTime();
  }}
}});
</script>
  '))
