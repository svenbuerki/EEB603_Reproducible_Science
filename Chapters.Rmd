...
**Balancing Open Science to support reproducibility with the values of your stakeholders can be a challenging task.**

Today, funding agencies and journals are increasingly promoting Open Science, a topic we began discussing in [Chapter 3](#chap3).

---

## Aim

The ***aim*** of this chapter is to **examine the mechanisms used to promote Open Science, while also recognizing situations in which other principles must be adopted to respect diverse perspectives, values, or data sovereignty (a.k.a., the CARE Principles)**.

Overall, this chapter aims to **provide solutions for addressing threats to the scientific process** (introduced in Chapters [1](#chap1) and [3](#chap3)), as well as **guidance on managing the data life cycle and disseminating research responsibly**.
...
- Understand the CARE Principles and the concept of data sovereignty, particularly in relation to Indigenous Peoples
