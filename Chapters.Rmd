...
**Each lead answers the comments on the section they wrote**, replying in each thread --- defend the clause, or concede and rewrite it there and then. Both are good answers; neither is a loss, and conceding to a good objection is the harder skill.

Once your charter has been revised in the light of the challenges, each student states, out loud, **one clause from their own section that they will apply to their own project this semester** --- starting now, not in principle.
