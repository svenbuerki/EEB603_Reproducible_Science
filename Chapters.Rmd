...
Each of these comes with a **💡 Your turn** exercise, and you build them up in the **same `.Rmd` file** as you go, knitting the document after each one to see the result. That file therefore has to be ready before you begin.
...
Once your file is ready, work through the sections in this order:
...
**This is the step to complete before any of the [syntax exercises](#basic-r-markdown-syntax).** Open the `Chapter_2_part_A.Rmd` file you created earlier and delete its content from line 11 (`## R Markdown`) to the end of the document, keeping the YAML header and the `setup` code chunk above it (see Figure \@ref(fig:beforestart)). You are left with an empty document that is ready to knit, and everything you add from here is your own.
