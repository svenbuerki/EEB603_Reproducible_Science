...
This tutorial corresponds to **Part B** of Chapter 1 and provides students with the opportunity to learn how to:
...
- [**Set your R Markdown environment**](#setRMd)  
  + Install R dependencies using an `*.R` script saved at the root of your working directory.  
  + Define the YAML metadata section.  
  + Load the required R packages.  
  + Generate a citation file for all R packages used to produce the report.  
  + Generate an appendix with citations for all R packages.  
  + Generate an appendix with R package versions used to produce the report.
...
To facilitate the teaching of the learning outcomes, a roadmap of the R Markdown file (`*.Rmd`) structure is summarized in Figure \@ref(fig:RMarkdwnstrct). This structure also applies to [Chapter 2 – Part C](#partC).
