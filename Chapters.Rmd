...
In this section, we will investigate the following question:
...
In this chapter, we will cover steps 1 to 4. Steps 5 and 7 have been respectively studied in chapters [1](#chap1) and 5 ([Data management](#partDM)), whereas step 6 will be covered in the bioinformatic tutorial associated to chapter 12.
