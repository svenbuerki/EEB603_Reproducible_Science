...
1. [Headers](#headers)  
2. [Inside text commenting](#comment) 
3. [Lists](#lists)  
4. [Italicized, bold, and combined formatting](#itbold) 
5. [Creating hyperlinks](#hyperlinks)  
6. [Embedded code chunks](#codechunkhow)  
7. [Inline code](#inlinecode)  
8. [Spell checking](#checkspell)
