...
Part A asked what reproducible science *is*, and why it fails. Part B asks **which factors break it** --- and then does something about them.
...
**The goal of Part B is to turn that evidence into a defence.** By the end of these two sessions your group will have written a **reproducibility charter**: a set of standards your research team commits to, each one chosen to block a specific factor known to break reproducible science. The diagnosis is where we start; the charter is what we are here to produce.
