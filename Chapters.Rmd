...
The primary reason for this approach is to maximize the portability of your R Markdown project, which is typically composed of a set of files (see Figure \@ref(fig:projstr)).
