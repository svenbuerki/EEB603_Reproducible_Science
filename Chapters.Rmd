...
3. The output file will be created in the same directory as your `.Rmd` file (Figure \@ref(fig:MyFirstRMfolder)). You can monitor the progress in the **R Markdown** console.  
    - If the knitting process fails, error messages will appear in the console, often indicating the line in the script where the error occurred (although this is not always the case). These messages are helpful for debugging your R Markdown document.
...
<div class="danger">
  <p><strong>💡 </strong> Your turn to practice this syntax in your document!</p>
</div>
...
We will delve more into chunk options in part C of chapter 2, but in the meantime please see the R Markdown Reference Guide for more details. 
...
Use material from [Chapter 2 - part A](#firstMDhow) to create and save your R Markdown document for this tutorial. 
...
<div class="danger">
  <p><strong>💡 </strong> The title of your document should be "Chapter 2 - part B", it should be saved as "Chapter2_partB.Rmd" at this path `Reproducible_Science/Chapters/Chapter_2` </p>
</div>
